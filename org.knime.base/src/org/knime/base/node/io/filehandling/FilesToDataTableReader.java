...
public interface FilesToDataTableReader {
     ...
     */
    public DataTableSpec createDataTableSpec(List<Path> paths) throws InvalidSettingsException;
     ...
     */
    public void pushRowsToOutput(Path path, RowOutput output, ExecutionContext exec) throws Exception;
