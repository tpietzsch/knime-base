...
final class FolderAndFilterPanelSwingWorker extends SwingWorker<Boolean, Boolean> {
    ...
    private final FolderAndFilterOptionsPanel m_filterAndFolderSettingsPanel;

    private final FileChooserHelper m_helper;

    FolderAndFilterPanelSwingWorker(final FileChooserHelper helper,
        final FolderAndFilterOptionsPanel filterAndFolderSettingsPanel) {
        m_helper = helper;
    ...
    protected Boolean doInBackground() throws Exception {
        ...
        if (model.getFileSystemChoice().equals(FileSystemChoice.getCustomFsUrlChoice())
            || model.getPathOrURL() == null || model.getPathOrURL().isEmpty()) {
